    ...
    <div className={`app-shell theme-${currentTheme}`}>
      ...
      <div className="body-layout">
        <aside className={`activitybar ${mobileMenu ? 'mobile-open' : ''}`}>
          <button className="avatar-button" onClick={() => selectView('home')} aria-label="Open home"><img src="/profile..jpeg" alt="Yash Khandelwal" /></button>
...
function BootScreen() { return <div className="boot-screen"><div className="boot-mark"><img src="/profile..jpeg" alt="Yash Khandelwal" /></div><div className="boot-title">YASH KHANDELWAL</div><div className="boot-progress"><span /><b>68%</b></div><p>Binding portfolio workspace channels...</p><div className="boot-log"><span>✓</span> CLIENT CONTAINER ONLINE<br /><span>✓</span> LOADING RESUME INDEX<br /><span className="blink">▌</span> DEPLOYING SERVER BINDING TO PORT 3000</div></div> }
...
function WorkspaceWelcome({ selectView, openAssistant }) {
  ...
  return (
    <section className="welcome-workspace">
      <div className="welcome-avatar"><img src="/profile..jpeg" alt="Yash Khandelwal" /></div>
      ...
      <aside className="settings-panel" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="settings-body">
          ...
          <div className="settings-footer">
            ...
            <p>Built with 💜 by Yash Khandelwal</p>
          </div>
